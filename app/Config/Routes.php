...
//CONTROLADOR PARA LA PARTE DEL CLIENTE
//LOCALHOST:8080/api
$routes->group('api',['namespace'=>'App\Controllers\API'],function($routes){
    //INVOCANDO EL CONTROLADOR 
    //LOCALHOST:8080/ESTUDIANTES --GET
    $routes->get('estudiantes','Estudiantes::index');
    //RUTA PARA GESTIONAR CREATE
    $routes->post('estudiantes/create','Estudiantes::create');
    //RUTA PARA LISTAR, sobrecargar con un valor
    $routes->get('estudiantes/show/(:num)','Estudiantes::show/$1');
    //RUTA PARA LISTAR, sobrecargar con un valor
    $routes->put('estudiantes/update/(:num)','Estudiantes::update/$1');
    //RUTA PARA ELIMINAR, sobrecargar con un valor
